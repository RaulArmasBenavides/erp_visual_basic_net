...
Public Class FrmvbCr
    ...
    Private Sub ExportListAspose()
        ...
        workbook.Settings.LanguageCode = DefaultEditLanguage.Auto
        ...
        'c.PutValue(0);
        '
        'Process.Start(path + "JETReport.csv")
        Dim fileWriter As New System.IO.StreamWriter("", True)
        fileWriter.WriteLine("")
        fileWriter.Close()
        'FileStream fs = File.Open(path + "book1_out.xls", FileMode.Open, FileAccess.ReadWrite);
        ' Save file And send to client browser using selected format
        ' workbook.Save(path & "book1_out.xlsx", SaveFormat.Csv)
